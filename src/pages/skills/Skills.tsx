...
const Skills = () => {
    ...
    return(
        <div className="about__me flex flex-row items-center p-3 h-full w-full" id="habilidades">

                <div className="w-full flex flex-row justify-center items-center">

                    <ul className="habilidades-containers flex flex-col gap-2 w-2/6 items-center">
                        <li>
                    ...
                    <div className="flex flex-col w-full items-center h-full p-2">
                        ...
                        <div className="habilidades-containers w-full">
                            <div className=" flex flex-row w-full items-center text-start">
                                ...
                                <span className="w-96 text-2xl habilidades-text">Capacidad de encarar proyectos sin necesidad de una constante supervisión. Trabajo cumpliento fechas de entregas y features del proyecto.</span>
                            </div>

                            <div className="flex flex-row w-full items-center text-end justify-end">
                                <span className="w-96 text-2xl habilidades-text">Aportar ideas frescas que puedan mejorar tiempos, costos o algun otro ámbito de producción</span>
                                <img  alt="idea-image" className="idea-image" src={ideaImage}/>
                            </div>

                            <div className="flex flex-row w-full items-center">
                                <img alt="idea-image" className="idea-image" src={feedbackImage}/>
                                <span className="w-96 text-2xl habilidades-text">Acostumbrado a trabajar con feedback para mejorar en lo que sea posible mejorar.</span>
                            </div>
                        </div>
